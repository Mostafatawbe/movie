...
if (isset($_POST['submit'])) {
    ...
    if (preg_match('/\D/', $contact) || strlen($contact) != 8) {
...
<body>
   ...
   <a href="index.php">
    ...
    <form method="post" id="form" autocomplete="off">
        ...
        <input class="input1" id="fn" name="firstName" type="text" placeholder="First Name *" required="required" autocomplete="off">
        <input class="input1" id="ln" name="lastName" type="text" placeholder="Last Name *" required="required" autocomplete="off">
        <input class="input1" id="user" name="username" type="text" placeholder="Username *" required="required" autocomplete="off">
        <input class="input1" id="email" name="email" type="text" placeholder="Email *" required="required" autocomplete="off">
        <input class="input1" id="pass" name="password" type="password" placeholder="Password *" required="required" autocomplete="new-password">
